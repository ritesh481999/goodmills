        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                {{ __('common.admin.add_form_title') }}
                    ...
                    <!--begin::Form-->
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="add-form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name" class="control-label">{{ __('common.admin_form.name.label') }}
                                            <span class="mandatory">*</span></label>
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="{{ __('common.admin_form.name.placeholder') }}"
                                            ...
                                            data-parsley-trigger='blur' value="{{ old('name') }}" />
                                        {!! $errors->first('name', '<p class="help-block text-danger">:message</p>') !!}
                                    </div>

                                    <div class="form-group">
                                        <label for="email" class="control-label">{{ __('common.admin_form.email.label') }}
                                            <span class="mandatory">*</span></label>
                                        <input type="email" class="form-control" name="email" id="email"
                                            placeholder="{{ __('common.admin_form.email.placeholder') }}"
                                            data-parsley-maxlength="100"
                                            ...
                                            data-parsley-trigger='input' value="{{ old('email') }}" />
                                        {!! $errors->first('email', '<p class="help-block text-danger">:message</p>') !!}
                                    </div>

                                    <div class="form-group">
                                        <label for="password"
                                            class="control-label">{{ __('common.admin_form.password.label') }} <span
                                                class="mandatory">*</span></label>
                                        <input type="password" class="form-control" name="password" id="password"
                                            placeholder="{{ __('common.admin_form.password.placeholder') }}"
                                            ...
                                            data-parsley-required='true'
                                            data-parsley-required-message="{{ __('common.admin_form.password.required') }}"
                                            data-parsley-trigger='input' />
                                        {!! $errors->first('password', '<p class="help-block text-danger">:message</p>') !!}
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label">{{ __('common.admin_form.countries.label') }} <span
                                                class="mandatory">*</span></label>
                                        <div class="custom-file">
                                            <select class="form-control country_id" id="country_id" name="countries[]"
                                                multiple="multiple" data-parsley-trigger="change blur"
                                                data-parsley-required='true'
                                    ...
                                    <div class="form-group">
                                        <label class="control-label">{{ __('common.admin_form.status.label') }} <span
                                                class="mandatory">*</span></label>
                                        <div class="custom-control custom-radio custom-control">
                                            <input type="radio" id="active-status" name="is_active"
                                                class="custom-control-input" value="1" checked>
                                            <label class="custom-control-label"
                                                for="active-status">{{ __('common.active') }}</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control">
                                            <input type="radio" id="inactive-status" name="is_active"
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <button type="submit" id="send_form"
                                            class="btn btn-brand">{{ __('common.submit') }}</button>
