...
@section('title', __('common.bid_location.add_bid_location'))
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                {{__('common.bid_location.add_bid_location_details')}}
                            </h3>
                        </div>
                        <div class="back-url-div">
                            <a href="{{ route('bid_location.index') }}" class="btn btn-brand btn-elevate btn-icon-sm back-url">
                    ...
                    action="{{ route('bid_location.store') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="title" class="control-label">
                                            {{__('common.bid_location.bid_location_name')}}<span class="mandatory">*</span></label>
                                        <input type="text" class="form-control" name="name" id="name" placeholder="{{__('common.bid_location.name_placeholder')}}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-radio custom-control">
                                            <input type="radio" id="active-status" name="status" class="custom-control-input" value="1" 
                                            checked>
