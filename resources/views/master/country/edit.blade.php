...
@section('title', __('common.masters.country.country_update_title'))
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            {{ __('common.masters.country.update_country_details') }}
                        </h3>
                    </div>
                ...
                {!! Form::model($country, ['class' => 'kt-form', 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'editCountry', 'url' => route('country.update', $country->id)]) !!}
                @csrf
