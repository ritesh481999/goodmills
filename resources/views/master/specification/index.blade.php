...
@section('title', __('common.masters.label.specification'))
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    {{ __('common.masters.specification.specification_list') }}
                </h3>
            </div>
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a href="{{ route('specification.create') }}" class="btn btn-add btn-elevate btn-icon-sm">
                            <i class="la la-plus"></i>
                            {{ __('common.masters.specification.add_specification') }}
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="kt-portlet__body">
            <div class="row input-daterange">
                ...
                <div class="col-md-4">
                    ...
                    <button type="button" name="reset" id="filter-reset" class="btn btn-reset">Reset</button>
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable data-table"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('common.masters.specification.commodity_name') }}</th>
                            <th>{{ __('common.masters.specification.specification_name') }}</th>
