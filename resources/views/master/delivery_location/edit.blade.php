...
@section('title',__('common.masters.delivery_location.delivery_location_update_title'))
									...
									<div class="kt-portlet">
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												...
												{{__('common.masters.delivery_location.update_delivery_location_details')}}
												</h3>
											</div>
										...
										<!--begin::Form-->
											 ...
											 {!! Form::model($dropoff,array('class' => 'kt-form','method'=>'patch','enctype' => 'multipart/form-data','id'=>'editdropoff','route' => ['delivery_location.update',$dropoff->id])) !!}
													...
													<div class="form-group">
														<label class="col-md-4 control-label">{{__('common.status')}} <span class="mandatory">*</span></label>
				                                         ...
				                                         <div class="custom-control custom-radio custom-control">
				                                            <input type="radio" id="active-status" name="status" class="custom-control-input" value="1" {{ $dropoff->status ? 'checked' : '' }}>
				                                            <label class="custom-control-label" for="active-status">{{__('common.active')}}</label>
				                                        </div>
				                                        <div class="custom-control custom-radio custom-control">
				                                            <input type="radio" id="inactive-status" name="status" class="custom-control-input" value="0" {{ $dropoff->status ? '' : 'checked' }}>
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<a href="{{ route('delivery_location.index') }}" class="btn btn-secondary">{{__('common.clear')}}</a>
												</div>
											</div>
										 {!! Form::close()!!}
										<!--end::Form-->
