...
@section('title', __('common.masters.label.delivery_location'))
...
@section('content')
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        {{__('common.masters.delivery_location.delivery_location_list')}}
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="{{ route('delivery_location.create') }}"
                                class="btn btn-add btn-elevate btn-icon-sm">
                                <i class="la la-plus"></i>
                                {{__('common.masters.delivery_location.add_delivery_location')}}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="kt-portlet__body">
                <div class="row input-daterange">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="to_date_range" data-filter="date_to" id="to_date_range"
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable data-table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>{{__('common.masters.label.delivery_location')}}</th>
    ...
    @section('script')
        <script type="text/javascript">
            var deleteRoute = '{{ route('delivery_location.destroy', ':id') }}';
        
            const dtable = $('#dropoffTable').DataTable({
                "language": {
                    paginate: {
                ...
                pageLength: 25,
                ajax: {
                    url: '{{ route('delivery_location.index') }}',
                    data: function(d) {
        ...
        <script src="{{ asset('js/delivery_location.js') }}" type="text/javascript"></script>
    @endsection
