...
return [
    ...
    'masters_error' =>  [
        'commodity' => [
            'name' => [
                'required' => 'The Commodity name field is required.',
                'string' => 'The Commodity name must be a string.',
                'max' => 'The Commodity name may not be greater than :max.',
                'unique' => 'The Commodity name has already been taken.',
            ],
            'status' => [
    ...
    'selling_request' => [
        ...
        'status' => [
            "request_recived" => "Request Recived",
            "bid_sent" => "Bid Sent",
            "request_rejected_by_admin" => "Request Rejected by admin",
            "bid_accepted_by_farmer" => "Bid Accepted by farmer",
            "bid_reject_by_farmer" => "Bid Rejected by farmer/Counter-offer recieved",
        ],
        'reject_popup' => [
