(function ($) {
    $.fn.imageUploader = function (options) {
        let defaults = {
            ...
            extensions: ['.jpg', '.jpeg', '.png', '.gif','.mp4','.webm','.mkv','.avi','.txt','.pdf'],
            mimes: ['image/jpeg', 'image/png', 'image/gif','video/mp4','video/mkv','video/avi','text/plain','application/pdf'],
            maxSize: 2097152*4,
            maxFiles: 10,
        };
        ...
        let validateMaxSize = function (file) {
            ...
            if (file.size > plugin.settings.maxSize) {
                ...
                Swal.fire({
                    title: `You should upload maximum size of ${plugin.settings.maxSize / 1024 / 1024}Mb`,
                    text: `The file "${file.name}" exceeds the maximum size of ${plugin.settings.maxSize / 1024 / 1024}Mb`,
                    type: 'warning',
